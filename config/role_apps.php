...
return [
    'apps' => [
        ...
        //     'url' => env('APP_CHANGE_URL', 'http://127.0.0.1:8000/api/api/sso/callback?token={token}'),
        //     'roles' => ['*'],
        //     'default_route' => '/',
        //     'role_urls' => [
        //         'staff' => env('APP_CHANGE_URL_STAFF', 'http://127.0.0.1:8000/api/api/sso/callback?token={token}'),
        //         'admin' => env('APP_CHANGE_URL_ADMIN', 'http://127.0.0.1:8000/api/api/sso/callback?token={token}'),
        //         'admin_kota' => env('APP_CHANGE_URL_ADMIN_KOTA', 'http://127.0.0.1:8000/api/api/sso/callback?token={token}'),
        //         'admin_dinas' => env('APP_CHANGE_URL_ADMIN_DINAS', 'http://127.0.0.1:8000/api/api/sso/callback?token={token}'),
        //         'kepala_seksi' => env('APP_CHANGE_URL_KEPALA_SEKSI', 'http://127.0.0.1:8000/api/api/sso/callback?token={token}'),
        //         'kepala_bidang' => env('APP_CHANGE_URL_KEPALA_BIDANG', 'http://127.0.0.1:8000/api/api/sso/callback?token={token}'),
        //         'kepala_dinas' => env('APP_CHANGE_URL_KEPALA_DINAS', 'http://127.0.0.1:8000/api/api/sso/callback?token={token}'),
        //         'diskominfo' => env('APP_CHANGE_URL_DISKOMINFO', 'http://127.0.0.1:8000/api/api/sso/callback?token={token}'),
        //         'auditor' => env('APP_CHANGE_URL_AUDITOR', 'http://127.0.0.1:8000/api/api/sso/callback?token={token}'),
        //     ],
        ...
        // ],
         'change' => [
            'name' => 'Change Management',
            'url' => env('APP_CHANGE_URL', 'http://127.0.0.1:8000/api/sso/callback?token={token}'),
            'roles' => ['*'],
            'default_route' => '/',
            'role_urls' => [
                'staff' => env('APP_CHANGE_URL_STAFF', 'http://127.0.0.1:8000/api/sso/callback?token={token}'),
                'admin' => env('APP_CHANGE_URL_ADMIN', 'http://127.0.0.1:8000/api/sso/callback?token={token}'),
                'admin_kota' => env('APP_CHANGE_URL_ADMIN_KOTA', 'http://127.0.0.1:8000/api/sso/callback?token={token}'),
                'admin_dinas' => env('APP_CHANGE_URL_ADMIN_DINAS', 'http://127.0.0.1:8000/api/sso/callback?token={token}'),
                'kepala_seksi' => env('APP_CHANGE_URL_KEPALA_SEKSI', 'http://127.0.0.1:8000/api/sso/callback?token={token}'),
                'kepala_bidang' => env('APP_CHANGE_URL_KEPALA_BIDANG', 'http://127.0.0.1:8000/api/sso/callback?token={token}'),
                'kepala_dinas' => env('APP_CHANGE_URL_KEPALA_DINAS', 'http://127.0.0.1:8000/api/sso/callback?token={token}'),
                'diskominfo' => env('APP_CHANGE_URL_DISKOMINFO', 'http://127.0.0.1:8000/api/sso/callback?token={token}'),
                'auditor' => env('APP_CHANGE_URL_AUDITOR', 'http://127.0.0.1:8000/api/sso/callback?token={token}'),
            ],
            'description' => 'Change & Configuration Management',
            'icon' => 'simantic.png',
        ],
