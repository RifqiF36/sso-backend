...
return [
    'apps' => [
        ...
        // ],
         'change' => [
            'name' => 'Change Management',
            'url' => env('APP_CHANGE_URL', 'http://localhost:5173/sso/callback?token={token}'),
            'roles' => ['*'],
            'default_route' => '/',
            'role_urls' => [
                'staff' => env('APP_CHANGE_URL_STAFF', 'http://localhost:5173/sso/callback?token={token}'),
                'admin' => env('APP_CHANGE_URL_ADMIN', 'http://localhost:5173/sso/callback?token={token}'),
                'admin_kota' => env('APP_CHANGE_URL_ADMIN_KOTA', 'http://localhost:5173/sso/callback?token={token}'),
                'admin_dinas' => env('APP_CHANGE_URL_ADMIN_DINAS', 'http://localhost:5173/sso/callback?token={token}'),
                'kepala_seksi' => env('APP_CHANGE_URL_KEPALA_SEKSI', 'http://localhost:5173/sso/callback?token={token}'),
                'kepala_bidang' => env('APP_CHANGE_URL_KEPALA_BIDANG', 'http://localhost:5173/sso/callback?token={token}'),
                'kepala_dinas' => env('APP_CHANGE_URL_KEPALA_DINAS', 'http://localhost:5173/sso/callback?token={token}'),
                'diskominfo' => env('APP_CHANGE_URL_DISKOMINFO', 'http://localhost:5173/sso/callback?token={token}'),
                'auditor' => env('APP_CHANGE_URL_AUDITOR', 'http://localhost:5173/sso/callback?token={token}'),
            ],
            'description' => 'Change & Configuration Management',
            'icon' => 'simantic.png',
        ],
