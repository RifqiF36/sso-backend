...
return [
    'apps' => [
        ...
        // ],
         'change' => [
            'name' => 'Change Management',
            'url' => env('APP_CHANGE_URL', 'https://api.simantic.online/api/sso/callback?token={token}'),
            'roles' => ['*'],
            'default_route' => '/',
            'role_urls' => [
                'staff' => env('APP_CHANGE_URL_STAFF', 'https://api.simantic.online/api/sso/callback?token={token}'),
                'admin' => env('APP_CHANGE_URL_ADMIN', 'https://api.simantic.online/api/sso/callback?token={token}'),
                'admin_kota' => env('APP_CHANGE_URL_ADMIN_KOTA', 'https://api.simantic.online/api/sso/callback?token={token}'),
                'admin_dinas' => env('APP_CHANGE_URL_ADMIN_DINAS', 'https://api.simantic.online/api/sso/callback?token={token}'),
                'kepala_seksi' => env('APP_CHANGE_URL_KEPALA_SEKSI', 'https://api.simantic.online/api/sso/callback?token={token}'),
                'kepala_bidang' => env('APP_CHANGE_URL_KEPALA_BIDANG', 'https://api.simantic.online/api/sso/callback?token={token}'),
                'kepala_dinas' => env('APP_CHANGE_URL_KEPALA_DINAS', 'https://api.simantic.online/api/sso/callback?token={token}'),
                'diskominfo' => env('APP_CHANGE_URL_DISKOMINFO', 'https://api.simantic.online/api/sso/callback?token={token}'),
                'auditor' => env('APP_CHANGE_URL_AUDITOR', 'https://api.simantic.online/api/sso/callback?token={token}'),
            ],
            'description' => 'Change & Configuration Management',
            'icon' => 'simantic.png',
        ],
