...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="otp-box">
                <div style="color: #6b7280; font-size: 14px; margin-bottom: 10px;">Kode Reset Password</div>
                <div class="otp-code">{{ $otp }}</div>
                <div style="color: #6b7280; font-size: 12px; margin-top: 10px;">Berlaku selama 10 menit</div>
            </div>

            <p>Masukkan kode ini bersama dengan password baru Anda pada halaman reset password.</p>
            
            <p class="warning">⚠️ Jangan bagikan kode ini kepada siapapun. Tim kami tidak akan pernah meminta kode OTP Anda.</p>
            
            <p>Jika Anda tidak melakukan permintaan reset password, abaikan email ini dan pastikan akun Anda aman.</p>
        </div>
        <div class="footer">
